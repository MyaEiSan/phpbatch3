...
<footer class="bg-dark px-5">
		<div class="container-fluid">
			<div class="row text-light py-4">
				<div class="col-md-3 col-sm-6">
					<h5 class="mb-3"><img src="<?php echo URLROOT; ?>/public/assets/img/fav/favicon.png" width="70px" alt="footericon" />About PLANNCO</h5>
	...
	<!-- End Footer Section -->
     ...
     <!-- bootstrap css1 js1 -->
	<script src="<?php echo URLROOT; ?>/public/assets/libs/bootstrap-5.2.0-beta1-dist/js/bootstrap.bundle.min.js" type="text/javascript"></script>
	<!-- jquery js1 -->
	<script src="<?php echo URLROOT; ?>/public/assets/libs/jquery-3.6.0/jquery-3.6.0.min.js" type="text/javascript"></script>

	<!-- jqueryui css1 js1 -->
	<script src="<?php echo URLROOT; ?>/public/assets/libs/jquery-ui-1.13.1/jquery-ui.min.js" type="text/javascript"></script>
	<!-- lightbox css1 js1 -->
	<script src="<?php echo URLROOT; ?>/public/assets/lightbox2-2.11.3/dist/js/lightbox.min.js" type="text/javascript"></script>
	<script src="<?php echo URLROOT; ?>/public/js/app.js" type="text/javascript"></script>
