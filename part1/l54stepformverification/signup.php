	...
	<div class="container">
		...
		<form id="form" action="./registerfunction.php" method="post" enctype="multipart/form-data">
			...
			<div class="page">
				...
				<div>
					<input type="radio" name="newsletter" id="agree" class="form-check-input" value="1" checked /><label for="agree" class="form-check-label"> I agree to get new letter.</label>
					<br/>
					<input type="radio" name="newsletter" id="noagree" class="form-check-input" value="0" checked /><label for="noagree" class="form-check-label"> I agree to get new letter.</label>
				</div>
			</div>
